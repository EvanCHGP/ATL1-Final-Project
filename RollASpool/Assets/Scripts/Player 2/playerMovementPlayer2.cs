...
public class playerMovementPlayer2 : MonoBehaviour
{
    ...
    void Update()
    {
        //Left Arrow & Right Arrow movement call 
    ...
    public void Die()
    {
        ...
        if(alive) 
        {
            ...
            foreach(groundTilePlayer2 _groundTile2 in FindObjectsOfType<groundTilePlayer2>())
            {
                _groundTile2.GetComponent<BoxCollider>().enabled = false;
            ...
            {
                gameOver.Setup(FindObjectOfType<GameManagerPlayer2>().score);
            } 
